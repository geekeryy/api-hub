...
// 解绑邮箱
func MemberUnbindEmailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MemberUnbindEmailReq
		...
		l := member.NewMemberUnbindEmailLogic(r.Context(), svcCtx)
		err := l.MemberUnbindEmail(&req)
		if err != nil {
